        ...
        <div class="w-3/4 p-4 mr-4 bg-white border border-gray-200">
            ...
            <div>
                ...
                <div>
                    ...
                    <div>
                        <a @click.prevent="store" class="inline-block bg-indigo-400 text-white text-xs px-3 py-2 rounded-lg" href="#">Send</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="w-1/4 p-4 p-2 bg-white border border-gray-200">
